...
export default function PackageCard({
  ...
  return (
    <div className={glow ? 'relative p-2 rounded-[1.6rem] h-fit overflow-hidden bg-[radial-gradient(120%_120%_at_100%_0%,_rgba(191,65,201,1)_0%,_rgba(190,24,93,0.8)_50%,_rgba(244,114,182,0.5)_100%)]' : 'p-2 rounded-[1.6rem]'}>
    {glow && (
    ...
    <div className="relative z-10 rounded-3xl border border-white/10 shadow-xl p-4 md:p-6 overflow-hidden bg-gradient-to-br from-zinc-800 to-zinc-900">
      ...
      <div className="mt-8 flex items-center justify-between">
        ...
        <Link href={viewAllHref} className="text-fuchsia-300 hover:text-fuchsia-200 text-sm md:text-base">
          view all
        </Link>
      </div>
